...
- Plain TypeScript test files for duality roll parsing, alias validation/expansion, Dice+ result conversion, and the local-only system messages helpers (`test/systemMessages.test.ts`).
